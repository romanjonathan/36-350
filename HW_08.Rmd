...
tester <- function() {
  test_that(desc = "Error: f(\"a\") should == 0", expect_equal(f("a"), 0))
  test_that(desc = "Error: f(\"A\") should == 0", expect_equal(f("A"), 0))
  test_that(desc = "Error: f(1) should have thrown a non char input exception",
         expect_error(f(1)))
  test_that(desc = "Error: f(list of strings) should throw an exception",
         expect_error(f(c("b", "b", "c"))))
